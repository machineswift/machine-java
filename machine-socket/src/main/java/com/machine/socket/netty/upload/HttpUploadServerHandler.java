 ...
 * under the License.
 */
package com.machine.socket.netty.upload;
...
public class HttpUploadServerHandler extends SimpleChannelInboundHandler<HttpObject> {
	...
	private final static String BASE_DITRCTORY = "E:\\temp";
    ...
    static {
        DiskFileUpload.deleteOnExitTemporaryFile = true; // should delete file
                                                         // on exit (in normal
                                                         // exit)
        DiskFileUpload.baseDirectory = BASE_DITRCTORY; // system temp directory
        DiskAttribute.deleteOnExitTemporaryFile = true; // should delete file on
                                                        // exit (in normal exit)
        DiskAttribute.baseDirectory = BASE_DITRCTORY; // system temp directory
    }
        ...
        if (data.getHttpDataType() == HttpDataType.Attribute) {
            ...
            if (data.getHttpDataType() == HttpDataType.FileUpload) {
                ...
                if (fileUpload.isCompleted()) {
                    ...
                    // or on File
                     try {
						fileUpload.renameTo(new File(fileUpload.getFile().getPath()+fileUpload.getFilename()));
					} catch (IOException e) {
						e.printStackTrace();
